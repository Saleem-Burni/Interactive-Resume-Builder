window.addEventListener("load", () => {
  ...
  let userName = document.getElementById('name')!.textContent = localStorage.getItem('myName') || 'SALEEM UDDIN BURNI';
  document.getElementById('designation')!.textContent = localStorage.getItem('desig') || 'FRONTEND DEVELOPER';
  document.getElementById('phone')!.textContent = localStorage.getItem('Phone') || '0345-8768177';
  document.getElementById('email')!.textContent = localStorage.getItem('email') || 'expertsaleem@gmail.com';
  document.getElementById('address')!.textContent = localStorage.getItem('add') || 'St 1/1/35 Commercial Area Ahsanabad Sector 1 Karachi';
  ...
  // Picture section
  (document.getElementById('picture') as HTMLImageElement).src = localStorage.getItem('form_profilePic') || 'profile.jpg';
